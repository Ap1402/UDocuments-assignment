          ...
          <div class="form-group row">
            ...
            <div class="col-sm-6 my-auto">
              <select id="tipo_inst" name="tipo_inst" class="form-control" data-toggle="tooltip" data-placement="top"
                ...
                <?php echo ($_SESSION['nivel'] == 1 || $verificar_check == 0) ? 'required' : 'readonly disabled' ?>>
                <option disabled selected value="<?php echo $tipo_inst ?>"><?php echo $tipo_inst_name ?></option>
          ...
          <div class="form-group row">
            <div class="col-sm-6 my-auto">
              <select id="carrera" name="carrera" class="form-control" data-toggle="tooltip" data-placement="top"
                title="Carrera" <?php echo ($_SESSION['nivel'] == 1 || $verificar_check == 0) ? 'required' : 'readonly disabled' ?>>
            ...
            <div class="col-sm-6 my-auto">
              <select id="turno" name="turno" class="form-control" data-toggle="tooltip" data-placement="top"
                title="Turno" <?php echo ($_SESSION['nivel'] == 1 || $verificar_check == 0) ? 'required' : 'readonly disabled' ?>>
