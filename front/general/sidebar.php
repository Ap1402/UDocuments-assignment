...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <!-- ============================== Para los ADMINISTRADORES $rol='HardRock' ============================== -->

  <?php if ($rol >= 3) { // Mostrar solo para administradores $rol='HardRock' ?>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" data-toggle="collapse" data-target="#collapseAdminEdit" aria-expanded="true"
 ...
 <?php if (($rol >= 1 && isset($_GET['ida']) || $rol >= 2)) { // Mostrar solo para admin $rol='Rock' ?>
  <!-- Divider -->
  <hr class="sidebar-divider">
  ...
  <!-- ============================== Para los ADMINISTRADORES $rol='AlternativeRock' ============================== -->

  <?php if ($rol >= 2) { // Mostrar solo para administradores $rol='AlternativeRock' ?>
  ...
  <!-- ============================== Para los ADMINISTRADORES $rol='Rock' ============================== -->

  <?php if ($rol >= 1 && isset($_GET['ida'])) { // Mostrar solo para admin $rol='Rock' ?>
  ...
  <?php if ($rol >= 2 && isset($_GET['ida'])) { // Mostrar solo para admin $rol='AlternativeRock' ?>
    <!-- Nav Item - Datos -->
    <li class="nav-item">
  ...
  <li class="nav-item">
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <?php if ($rol >= 2 ) { // Mostrar solo para admin $rol='AlternativeRock' ?>
        <a class="collapse-item"
 ...
 <!-- Divider -->
  ...
  <!-- Nav Item - Edicion Datos/Documentos -->
  <li class="nav-item">
    <a class="nav-link collapsed" data-toggle="collapse" data-target="#collapseStudentEdit" aria-expanded="true"
