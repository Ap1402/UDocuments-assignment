    ...
    <div class="form-group row">
      ...
      <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
        ...
        <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" class="form-control"
          placeholder="Fecha nacimiento" min="<?php echo date('Y-m-d', strtotime('-150 year')) ?>"
    ...
    <div class="form-group row">
      <div class="col-sm-12 col-md-6">
        ...
        <input type="number" id="habitacion" name="habitacion" class="form-control" placeholder="Teléfono de habitación"
          min="2400000000" pattern="\d*.{11,13}">
        <div class="invalid-feedback">
  ...
  <br>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
        ...
        <input type="text" id="municipio" name="municipio" class="form-control" placeholder="Municipio" minlength="4"
          required>
        <div class="invalid-feedback">
          Este campo debe tener al menos 4 caracteres.
        </div>
  ...
  <br>
    ...
    <div class="form-group row">
      <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
        ...
        <input type="text" id="nac_postal" name="nac_postal" class="form-control" placeholder="Zona postal"
      ...
      <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
        <label class="pl-2"><small>Estado <span class="text-xs text-danger"> *</span></small></label><br>
        <input type="text" id="nac_estado" name="nac_estado" class="form-control" placeholder="Estado" minlength="4"
          required>
        <div class="invalid-feedback">
          Este campo debe tener al menos 4 caracteres.
        </div>
      ...
      <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
        <label class="pl-2"><small>Ciudad <span class="text-xs text-danger"> *</span></small></label><br>
        <input type="text" id="nac_ciudad" name="nac_ciudad" class="form-control" placeholder="Ciudad" minlength="4"
          required>
        <div class="invalid-feedback">
          Este campo debe tener al menos 4 caracteres.
        </div>
      ...
      <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
        <label class="pl-2"><small>Municipio <span class="text-xs text-danger"> *</span></small></label><br>
        <input type="text" id="nac_municipio" name="nac_municipio" class="form-control" placeholder="Municipio"
          minlength="4" required>
        <div class="invalid-feedback">
          Este campo debe tener al menos 4 caracteres.
        </div>
    ...
    <div class="form-group row">
      <div class="col-sm-12 col-md-6 col-lg-4">
        ...
        <input type="text" id="nac_urbanizacion" name="nac_urbanizacion" class="form-control" placeholder="Urbanización"
          minlength="4" required>
        <div class="invalid-feedback">
          Este campo debe tener al menos 4 caracteres.
        </div>
      ...
      <div class="col-sm-12 col-md-6 col-lg-4">
        ...
        <input type="text" id="nac_aptcasa" name="nac_aptcasa" class="form-control" placeholder="Casa o Apartamento"
      ...
      <div class="col-sm-12 col-md-12 col-lg-4">
        ...
        <input type="text" id="nac_calle" name="nac_calle" class="form-control" placeholder="Calle" minlength="1"
          required>
        <div class="invalid-feedback">
          Este campo debe tener al menos 1 caracter.
        </div>
  ...
  <br>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
        <label class="pl-2"><small>Municipio <span class="text-xs text-danger"></span></small></label><br>
        <input type="text" id="t_municipio" name="t_municipio" class="form-control" placeholder="Municipio"
          minlength="4">
        <div class="invalid-feedback">
          Este campo debe tener al menos 4 caracteres.
        </div>
  ...
  <br>
    ...
    <div class="form-group row">
      <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
        ...
        <input type="text" id="e_nombre" name="e_nombre" class="form-control" placeholder="Nombre y apellido"
      ...
      <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
        ...
        <input type="text" id="parentesco" name="parentesco" minlength="3" class="form-control" placeholder="Parentesco"
          required>
        <div class="invalid-feedback">
      ...
      <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
        ...
        <input type="number" id="e_movil" name="e_movil" class="form-control" placeholder="Teléfono móvil"
          min="4100000000" pattern="\d*.{11,13}" required>
        <div class="invalid-feedback">
          Este campo debe tener al menos 11 cifras.
        </div>
      </div>
    ...
    <div class="form-group row">
      <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
        <label class="pl-2"><small>Nombre de la institución (no abreviar) <span class="text-xs text-danger">
              *</span></small></label><br>
        <input type="text" id="i_nombre" name="i_nombre" class="form-control"
      ...
      <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
        ...
        <input type="number" id="i_egreso" name="i_egreso" class="form-control" placeholder="Año de egreso" min="1930"
          pattern="\d*.{4,4}" max="<?php echo date('Y') ?>" required>
        <div class="invalid-feedback">
      ...
      <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
        <label class="pl-2"><small>Código de la institución <span class="text-xs text-danger">
              *</span></small></label><br>
        <input type="text" id="i_codigo" name="i_codigo" class="form-control" placeholder="Código de la institución"
      ...
      <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
        <label class="pl-2"><small>Estado <span class="text-xs text-danger"> *</span></small></label><br>
        <input type="text" id="i_estado" name="i_estado" class="form-control" placeholder="Estado" minlength="4"
          required>
        <div class="invalid-feedback">
          Este campo debe tener al menos 4 caracteres.
        </div>
