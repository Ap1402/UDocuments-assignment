...
$consulta = "UPDATE documentos SET check_foto='$check_foto',check_cedula='$check_cedula', check_fondo='$check_fondo', check_nota='$check_notas', check_partida='$check_partida', check_rusinies='$check_rusnies', check_metodo='$check_metodo'  WHERE id_documento=$id_doc";
