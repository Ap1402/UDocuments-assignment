...
$sql_total = "SELECT COUNT(*) FROM solicitudes LEFT JOIN tipo_solicitud
              ON solicitudes.tipo=tipo_solicitud.tipo WHERE (activa=1)";
...
$sql_intro = "SELECT COUNT(*), activa FROM solicitudes LEFT JOIN tipo_solicitud
              ON solicitudes.tipo=tipo_solicitud.tipo WHERE (activa=1) AND (solicitudes.tipo=1)";

$result_intro = mysqli_query($conexion, $sql_intro);
$row_intro = mysqli_fetch_assoc($result_intro);
$intro = $row_intro['COUNT(*)'];
$intro_activa = $row_intro['activa'];

$sql_basic = "SELECT COUNT(*), activa FROM solicitudes LEFT JOIN tipo_solicitud
              ON solicitudes.tipo=tipo_solicitud.tipo WHERE (activa=1) AND (solicitudes.tipo=2)";

$result_basic = mysqli_query($conexion, $sql_basic);
$row_basic = mysqli_fetch_assoc($result_basic);
$basic = $row_basic['COUNT(*)'];
$basic_activa = $row_basic['activa'];

$sql_admis = "SELECT COUNT(*), activa FROM solicitudes LEFT JOIN tipo_solicitud
              ON solicitudes.tipo=tipo_solicitud.tipo WHERE (activa=1) AND (solicitudes.tipo=3)";

$result_admis = mysqli_query($conexion, $sql_admis);
$row_admis = mysqli_fetch_assoc($result_admis);
$admis = $row_admis['COUNT(*)'];
$admis_activa = $row_admis['activa'];

$sql_direc = "SELECT COUNT(*), activa FROM solicitudes LEFT JOIN tipo_solicitud
              ON solicitudes.tipo=tipo_solicitud.tipo WHERE (activa=1) AND (solicitudes.tipo=4)";

$result_direc = mysqli_query($conexion, $sql_direc);
$row_direc = mysqli_fetch_assoc($result_direc);
$direc = $row_direc['COUNT(*)'];
$direc_activa = $row_direc['activa'];

$sql_equiv = "SELECT COUNT(*), activa FROM solicitudes LEFT JOIN tipo_solicitud
              ON solicitudes.tipo=tipo_solicitud.tipo WHERE (activa=1) AND (solicitudes.tipo=5)";

$result_equiv = mysqli_query($conexion, $sql_equiv);
$row_equiv = mysqli_fetch_assoc($result_equiv);
$equiv = $row_equiv['COUNT(*)'];
$equiv_activa = $row_equiv['activa'];

$sql_reinc = "SELECT COUNT(*), activa FROM solicitudes LEFT JOIN tipo_solicitud
              ON solicitudes.tipo=tipo_solicitud.tipo WHERE (activa=1) AND (solicitudes.tipo=6)";

$result_reinc = mysqli_query($conexion, $sql_reinc);
$row_reinc = mysqli_fetch_assoc($result_reinc);
$reinc = $row_reinc['COUNT(*)'];
$reinc_activa = $row_reinc['activa'];
            ...
            <div class="col-12 mb-3">
              ...
              <div class="card shadow">
                ...
                <div class="card-body">
                  ...
                  <?php };?>
                  <?php
                  $sql_sol_activa = "SELECT * FROM tipo_solicitud WHERE activa=1";

                  $result_sol_activa = mysqli_query($conexion, $sql_sol_activa);
                  if ($result_sol_activa->num_rows == 0){
                    echo 'Todas las Solicitudes estan deshabilitadas';
                  };
                  ?>
